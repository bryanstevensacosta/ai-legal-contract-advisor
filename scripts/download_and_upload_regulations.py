...
class RegulatoryDocumentUploader:
    ...
    def __init__(self):
        ...
        if not all([cos_api_key, cos_instance_id]):
            raise ValueError(
                "Missing COS credentials. Please set COS_API_KEY and COS_INSTANCE_ID"
            )
    ...
    def create_placeholder_document(self, regulation_name: str, jurisdiction: str, 
                                   url: str, key_points: list) -> bytes:
