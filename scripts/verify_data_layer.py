...
class DataLayerVerifier:
    ...
    def verify_cloudant_database(self, db_name: str, expected_min_docs: int = 0) -> bool:
        ...
        try:
            ...
            if doc_count >= expected_min_docs:
                ...
                print(f"  ⚠️  {db_name}: {doc_count} documents (expected at least {expected_min_docs})")
                return False
    ...
    def verify_cloudant_indexes(self, db_name: str, expected_indexes: list) -> bool:
        ...
        try:
            # Get all indexes
            result = self.cloudant_client.post_explain(
                db=db_name,
    ...
    def verify_cos_bucket(self) -> bool:
        ...
        try:
            ...
            if total_pdfs == 0:
                print(f"  ⚠️  No PDFs uploaded yet. Run upload instructions from setup_cos_buckets.py")
                return False
