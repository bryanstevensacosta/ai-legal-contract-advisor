...
class WatsonxClient:
        ...
        for attempt in range(self.max_retries):
            try:
                ...
                if attempt < self.max_retries - 1:
                    ...
                    logger.error(f"watsonx.ai operation failed after {self.max_retries} attempts: {e}")
    ...
    def generate(
        ...
        temperature = temperature if temperature is not None else float(os.getenv('WATSONX_TEMPERATURE', '0.1'))
