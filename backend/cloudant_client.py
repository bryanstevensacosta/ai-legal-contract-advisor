...
class CloudantClient:
    ...
    def __init__(
        ...
        self.db_historical_decisions = os.getenv('CLOUDANT_DB_HISTORICAL_DECISIONS', 'historical_decisions')
        self.db_regulatory_mappings = os.getenv('CLOUDANT_DB_REGULATORY_MAPPINGS', 'regulatory_mappings')
        ...
        for attempt in range(self.max_retries):
            try:
                ...
                if attempt < self.max_retries - 1:
                    ...
                    logger.error(f"Cloudant operation failed after {self.max_retries} attempts: {e}")
    ...
    def get_regulatory_mappings(
        ...
        def _query():
            ...
            # Execute query
            result = self.client.post_find(
                db=self.db_regulatory_mappings,
                selector=selector,
                limit=limit
            ).get_result()
    ...
    def health_check(self) -> Dict[str, Any]:
        ...
        try:
            ...
            databases = {}
            for db_name in [self.db_golden_clauses, self.db_historical_decisions, self.db_regulatory_mappings]:
                try:
