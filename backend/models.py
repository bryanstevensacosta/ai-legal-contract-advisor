...
class FusionAnalysis(BaseModel):
    ...
    internal_signals: List[InternalSignal] = Field(default_factory=list, description="Internal signals")
    external_signals: List[ExternalSignal] = Field(default_factory=list, description="External signals")
    historical_signals: List[HistoricalSignal] = Field(default_factory=list, description="Historical signals")
...
class LegalLogicTrace(BaseModel):
    ...
    recommendations: List[RecommendedAction] = Field(default_factory=list, description="Recommendations")
